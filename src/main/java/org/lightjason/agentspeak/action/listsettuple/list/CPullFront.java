...
/**
 * pulls elements from the list front.
 * First argument is a list, second optional argument
 * is the number of elements that are pulled, default
 * is one element
 *
 * {@code [A|B] = .collection/list/pullfront( L, 2 );}
 */
public final class CPullFront extends IBaseAction
{
    /**
     * serial id
     */
    private static final long serialVersionUID = 2749161918256550803L;
    /**
     * action name
     */
    private static final IPath NAME = namebyclass( CPullFront.class, "collection", "list" );
